...
lib.listToAttrs (lib.flatten (
  ...
  (lib.unique (lib.filter (drv: drv.meta ? position && !drv.meta.unsupported && !drv.meta.broken && !drv.meta.unfree && (drv.meta ? dependsUnfree -> !drv.meta.dependsUnfree)) (lib.collect
